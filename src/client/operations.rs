                    ...
                    replica_futures.push(tokio::spawn(async move {
                        ...
                        .map_err(|e| {
                            RustreError::Internal(format!(
                                "sendfile to replica task panicked: {}",
                                e
                            ))
                        })?;
...
/// Helper function for a single OST writer task using zero-copy sendfile for Windows
